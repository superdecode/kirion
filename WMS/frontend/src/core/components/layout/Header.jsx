...
export default function Header({ title, subtitle, actions }) {
  ...
  return (
    <>
      <header className="h-16 bg-white/80 backdrop-blur-lg border-b border-warm-100 px-6 flex items-center gap-3 shrink-0 sticky top-0 z-10">
        {/* Title */}
        ...
        <div ref={menuRef} className="relative">
          ...
          {/* Dropdown */}
          {userMenuOpen && (
            <div className="absolute right-0 top-full mt-2 w-72 bg-white rounded-2xl shadow-card-hover border border-warm-100 overflow-hidden animate-scale-in z-50">
              {/* User info header */}
