        ...
        <div className="p-4">
          <div className="max-w-full mx-auto space-y-4">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
              <KPICard icon={Package} label="Total Guías" value={r.total_guias} gradient="from-primary-500 to-primary-700" iconBg="bg-primary-400/20" />
              <KPICard icon={CheckCircle} label="Completas" value={r.tarimas_completadas} gradient="from-success-500 to-accent-600" iconBg="bg-success-400/20" />
              <KPICard icon={Clock} label="En Proceso" value={r.tarimas_en_proceso} gradient="from-warning-400 to-warning-600" iconBg="bg-warning-400/20" />
              <KPICard icon={AlertTriangle} label="Duplicados" value={r.alertas_duplicados} gradient="from-danger-400 to-danger-600" iconBg="bg-danger-400/20" />
              <KPICard icon={TrendingUp} label="Tiempo Prom." value={`${r.tiempo_promedio_minutos || 0}m`} gradient="from-accent-500 to-primary-600" iconBg="bg-accent-400/20" />
            </div>
...
function KPICard({ icon: Icon, label, value, gradient, iconBg }) {
  return (
    <div className="card-interactive p-5 group overflow-hidden relative">
      <div className={`absolute -right-4 -top-4 w-20 h-20 rounded-full bg-gradient-to-br ${gradient} opacity-[0.07] group-hover:opacity-[0.12] transition-opacity duration-500`} />
