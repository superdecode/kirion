          ...
          <tbody class="fw-bold text-gray-600">
            ...
            if (!empty($datas)) {
              foreach ($datas as $k => $rows) {
                ...
                $edit['query'] = $query;
                $message_details = base_url('Messages/message_list/' . $seller_id);
            ...
            ?>
                <tr id="tr_<?= $rows->id ?>">
                  ...
                  <td>
                    <a href="<?= $message_details ?>"><?= $rows->seller_name ?></a>
                  </td>
                  <!--<td>
