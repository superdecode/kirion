...
<div class="modal fade " id="kt_modal_add" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <?php
            $this->load->view('admin/saveBrand');
            ?>
            <!--end::Form-->											
        </div>
    </div>
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        if (!empty($datas)) {
                            foreach ($datas as $k => $rows) {
                                ...
                                $edit_link = base_url('Products/saveBrand/' . $id);
                                $delete_link = base_url('Products/removeBrand/' . $id);
                                $status_link = base_url('Products/statusChangeBrand/' . $id);
                                $query = $this->Product_model->getBrandDetails($rows->id);
                                $edit['query'] = $query;
                                ...
                                <div class="modal fade " id="kt_modal_edit<?= $rows->id ?>" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-800px">
                                        ...
                                        <div class="modal-content">
                                            <!--begin::Form-->
                                            <?php $this->load->view('admin/saveBrand', $edit); ?>
                                            <!--end::Form-->											
                                        </div>
                                    </div>
                                </div>
...
$this->load->view('admin/_brand_js', $this->data);
