...
<form class="form" id="update_form_<?=$query->id?>" method="POST" action="<?=base_url('Products/attributeSave/'.$query->id)?>" id="" data-kt-redirect="<?=base_url('ExpeditionsCategory/save/'.$query->id)?>" enctype="multipart/form-data">
	...
	<div class="modal-header" id="kt_modal_edit_header">
		<!--begin::Modal title-->
		<h2 class="fw-bolder">Save Attributes</h2>
		<!--end::Modal title-->
		<!--begin::Close-->
	...
	<div class="modal-body py-10 px-lg-17">
		...
		<div class="scroll-y me-n7 pe-7" id="kt_modal_edit_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_header" data-kt-scroll-wrappers="#kt_modal_edit_scroll" data-kt-scroll-offset="300px">
                    ...
                    <div class="fv-row mb-7">
                        <label class="required fs-6 fw-bold mb-2">Attributes Name</label>
                        <input class="form-control form-control-solid" type="text" value="<?=$query->attribute_name?>" name="attribute_name" placeholder="Attributes Name" autocomplete="off" required>      
		    </div>
