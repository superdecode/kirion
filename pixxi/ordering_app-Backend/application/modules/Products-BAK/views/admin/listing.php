...
<!--end::Svg Icon-->
<input type="text" data-kt-listing-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Datas" />
</div>
<!--end::Search-->
</div>
<!--begin::Card title-->
...
<th class="">Product information</th>
<th class="">Seller</th>
<th class="">Status</th>
...
<td><?= $rows->cname ?> </td>
<td>								
<!--<strong>Total sales:</strong> <?= $rows->num_of_sale ?> times <br>-->
<strong></strong> <?php if($rows->variant_product==0){ echo 'Simple Product'; } ?> 
<?php if($rows->variant_product==1){ echo 'Variable Product'; } ?> <br>
<?php if($rows->variant_product==0){ ?>   
<strong>price:</strong> $<?= $rows->unit_price ?> 
<?php } ?>
</td>
<td><?= $rows->sname ?> </td>
