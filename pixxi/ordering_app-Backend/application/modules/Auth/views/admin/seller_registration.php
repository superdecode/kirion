...
<head>
    <base href="<?= base_url() ?>">
    <meta charset="utf-8" />
    <title><?= get_settings_value('system_name') ?> | Registro de vendedor</title>
    <?php
                        ...
                        <div class="w-lg-600px p-10 p-lg-15 mx-auto rounded" style="background-color: #fff;">
                            ...
                            <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" action="" autocomplete="off" method="POST">
                                ...
                                <div class="row fv-row mb-7 fv-plugins-icon-container">
                                    <!--begin::Col-->
                                    <div class="col-xl-6">
                                        <input class="form-control form-control-lg " type="text" placeholder="Nombre" name="fname" required autocomplete="off" data-kt-translate="sign-up-input-first-name">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-xl-6">
                                        <input class="form-control form-control-lg " type="text" placeholder="Apellido" name="lname" required autocomplete="off" data-kt-translate="sign-up-input-last-name">
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <div class="fv-row mb-8 fv-plugins-icon-container">
                                    <input type="text" placeholder="Número de Teléfono" name="phone_number" autocomplete="off" class="form-control bg-transparent">
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <div class="fv-row mb-8 fv-plugins-icon-container">
                                ...
                                <div class="fv-row mb-8 fv-plugins-icon-container" data-kt-password-meter="true">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control bg-transparent" type="password" placeholder="Contraseña" name="password" required autocomplete="off">
                                ...
                                <div class="fv-row mb-8 fv-plugins-icon-container">
                                    ...
                                    <input type="password" placeholder="Repita la contraseña" name="confirm_password" required autocomplete="off" class="form-control bg-transparent">
                                    <!--end::Repeat Password-->
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <!--end::Input group--->
                                ...
                                <div class="fv-row mb-8 fv-plugins-icon-container">
                                    <label class="form-check form-check-inline">
                                        ...
                                        <span class="form-check-label fw-semibold text-gray-700 fs-base ms-1">
                                            Aceptar los <a href="#" class="ms-1 link-primary">términos</a>
                                        </span>
                                    </label>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
