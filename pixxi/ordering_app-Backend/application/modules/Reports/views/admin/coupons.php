...
<?= $dis;?>       
<?php//=$rows->max_discount?></td>
<td><?=($rows->enable_date!='0000-00-00')?date('d-M-Y',strtotime($rows->enable_date)):''?> / <?=($rows->disable_date!='0000-00-00')?date('d-M-Y',strtotime($rows->disable_date)):''?></td>
<td data-filter="">
...
$this->load->view('admin/_js_coupon', $this->data);
