...
$edit_link = base_url('Orders/saveRefund/'.$id);
...
<td data-filter="">
<a href="javascript:void(0)" class="badge badge-light-<?=($rows->refund_status!='ongoing' && $rows->refund_status!='cancelled')?'success':'danger'?>">
