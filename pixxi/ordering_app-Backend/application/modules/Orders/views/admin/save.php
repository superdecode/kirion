        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack d-print-none">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-left me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="<?= base_url('Orders/listing') ?>" class="text-muted text-hover-primary">Lista de Pedidos</a>
                    </li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    </li>
            ...
            <div class="d-flex align-items-center py-1">
                <div class="">
                    ...
                    <a href="<?= base_url('Orders/listing') ?>" class="btn btn-white btn-active-light-danger me-2">Atrás</a>
                        ...
                        <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                            ...
                            <div class="mt-n1">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="col-sm-6">
                                    <div class="fw-bolder fs-3 text-gray-800">Factura #<?= $query->order_number ?></div>
                                    <div class="fw-bolder fs-3 text-gray-800 mb-8">Número De Recogida #<?= $query->pickup_number ?></div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <input type="hidden" name="order_id" value="<?= $query->id ?>" />
                                    <input type="hidden" name="buyer_id" value="<?= $query->buyer_id ?>" />
                                    <input type="hidden" name="seller_id" value="<?= $query->seller_id ?>" />
                                    <!--end::Label-->
                                    <!--begin::Row-->
                                    <div class="row g-5 mb-11">
                                        <!--end::Col-->
                                    ...
                                    <div class="row g-5 mb-12">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="fw-bold fs-7 text-gray-600 mb-1">A:</div>
                                                    ...
                                                    ?>
                                                            <tr class="fw-bolder text-gray-700 fs-5 text-end">
                                                                <td class="d-flex align-items-center pt-6">
                                                                    <i class="fa fa-genderless text-danger fs-2 me-2"></i><?= $orderItem->product_title ?> | <?= $query->order_type ?>
                                                                </td>
...
<div class="text-end fw-bolder fs-6 text-gray-800"><?= $query->tax_charges ?> $</div>
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
                                <!--begin::Labels-->
                                <div class="mb-8">
                                    <h6 class="mb-2 fw-boldest text-gray-600 text-hover-primary">Estado del Pedido</h6>
                                    <select name="order_status" class="form-control mb-4">
                                        <option <?php if($query->order_status == 'completed' || $query->order_status == 'cancelled' || $query->order_status == 'processing') {?>disabled="true"<?php } ?> value="awating_confirmation" <?= $query->order_status == 'awating_confirmation' ? 'selected' : '' ?>>Por Confirmar</option>
                                        <!--<option value="awaiting_payment" <?= $query->order_status == 'awaiting_payment' ? 'selected' : '' ?> >Awaiting Payment</option>-->
                                        <option <?php if($query->order_status == 'completed' || $query->order_status == 'cancelled') {?>disabled="true"<?php } ?> value="processing" <?= $query->order_status == 'processing' ? 'selected' : '' ?>>Procesando</option>
                                        <option <?php if($query->order_status == 'cancelled') {?> disabled="true"<?php } ?> value="completed" <?= $query->order_status == 'completed' ? 'selected' : '' ?>>Completado</option>
                                        <option <?php if($query->order_status == 'completed') {?> disabled="true"<?php } ?> value="cancelled" <?= $query->order_status == 'cancelled' ? 'selected' : '' ?>>Cancelado</option>
...
<?php */ ?>
                                ...
                                <div class="mb-6">
                                    ...
                                    <select name="payment_status" class="form-control mb-4">
                                        <option value="Paid" <?= $query->payment_status == 'payment_status' ? 'Paid' : '' ?>>Pagado</option>
                                        <option value="Unpaid" <?= $query->payment_status == 'Unpaid' ? 'selected' : '' ?>>Pendiente Pago</option>
