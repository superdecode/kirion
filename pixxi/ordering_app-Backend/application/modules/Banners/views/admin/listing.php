        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                        <div class="">
                                ...
                                <!--end::Svg Icon-->Agregar pancarta</button>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table">
                ...
                <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 gs-0">
                                ...
                                <th class="min-w-125px">Ubicación</th>
                                <th class="min-w-125px">Título</th>
                                <th class="min-w-125px">Nº De Pedido</th>
                ...
                if(!empty($datas)){
                        foreach($datas as $k=> $rows)
                        {
                                ...
                                $edit_link = base_url('Banners/save/'.$id);
                                $delete_link = base_url('Banners/remove/'.$id);
                                $status_link = base_url('Banners/statusChange/'.$id);
                                $query = $this->Banner_model->getBannerDetails($rows->id);
                                $edit['query']=$query;

                                if (!empty($rows->image)) {
                                        $img = base_url('assets/uploads/banner_images/' . $rows->image);
                                } else {
                ...
                ?>
                        <tr id="tr_<?=$rows->id?>">							
                            ...
                            <td>
                        <?php if($rows->location=='homepage') {
                            $location ='página de inicio';
                        }if($rows->location=='dashboard') {
                            $location ='Panel';
                        }if($rows->location=='seller_menu') {
                            $location ='Menú del vendedor';
                        }
                        ?>
                        <?= $location?></td>
                                <td>
                                    <a href="javascript:void()" class="text-gray-600 text-hover-primary mb-1" data-bs-toggle="modal" data-bs-target="#kt_modal_edit<?=$rows->id?>">
                                      <?php if($rows->title!=''){?>
                                        <?=$rows->title?>
                                      <?php } else {?>
                                        <?= 'Sin título'?>
