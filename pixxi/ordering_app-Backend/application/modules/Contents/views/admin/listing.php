	...
	<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
		...
		<div class="d-flex align-items-center py-1">
			<div class="">
				...
				<!--end::Svg Icon-->Agregar Contenido</button>
				...
				<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table">
					...
					if(!empty($datas)){
						foreach($datas as $k=> $rows)
						{
							...
							$edit_link = base_url('Contents/save/'.$id);
							$delete_link = base_url('Contents/remove/'.$id);
							$status_link = base_url('Contents/statusChange/'.$id);
							$query = $this->Content_model->getContentDetails($rows->id);
							$edit['query']=$query;
