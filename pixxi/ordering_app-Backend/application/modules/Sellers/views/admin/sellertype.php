        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                        <div class="">
                                ...
                                <!--end::Svg Icon-->Agregar Tipo</button>
...
<div class="modal fade " id="kt_modal_add" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-800px">
                ...
                <div class="modal-content">
                        <!--begin::Form-->
                        <?php			
                                $this->load->view('admin/seller_type_save'); 
                        ?>
                        <!--end::Form-->											
                </div>
        </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table">
                ...
                <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 gs-0">
                                ...
                                <th class="min-w-125px">Categoría Principal</th>
                ...
                if(!empty($datas)){
                        foreach($datas as $k=> $rows)
                        {
                                ...
                                $query = $this->Seller_model->getSellerTypeDetails($rows->id);
                                $edit['query']=$query;

                                if (!empty($rows->image)) {
                                        $img = base_url('assets/uploads/seller_type_images/' . $rows->image);
                                } else {
                ...
                ?>
                        <tr id="tr_<?=$rows->id?>">							
                            ...
                            <td><a href="javascript void(0)" data-bs-toggle="modal" data-bs-target="#kt_modal_edit<?=$rows->id?>"><?= ucfirst($rows->seller_type)?></a></td>
                           <td><?=!empty($rows->parent_cat)?$rows->parent_cat:'-'?></td>
                                <td>
                        ...
                        <div class="modal fade " id="kt_modal_edit<?=$rows->id?>" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-800px">
                                        ...
                                        <div class="modal-content">
                                                <!--begin::Form-->
                                                <?php $this->load->view('admin/seller_type_save', $edit); ?>
                                                <!--end::Form-->											
                                        </div>
                                </div>
                        </div>
...
$this->load->view('admin/_js_seller_type', $this->data);
?>
