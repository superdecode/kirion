        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                        <div class="">
                                ...
                                <!--end::Svg Icon-->Agregar Tabla</button>
...
<div class="modal fade " id="kt_modal_add" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-800px">
                ...
                <div class="modal-content">
                        <!--begin::Form-->
                        <?php			
                                $this->load->view('admin/seller_table_save'); 
                        ?>
                        <!--end::Form-->											
                </div>
        </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table">
                ...
                <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 gs-0">
                                ...
                                <th class="min-w-125px"><?php if($this->session->userdata('user_id')==1) {?>Nombre del Vendedor<?php } else {?>Nombre<?php } ?></th>
                                <th class="min-w-125px">Nombre de la Tabla</th>
                               <th class="min-w-125px">Código QR</th>
                ...
                if(!empty($datas)){
                        foreach($datas as $k=> $rows)
                        {
                                ...
                                $status_link = base_url('Sellers/sellerTypeStatusChange/'.$id);
                                $query = $this->Seller_model->getSellerTableNumber($rows->id);
                                $print_link = base_url('Sellers/print_table_qr/'.$id);
                                $edit['query']=$query;

                                if (!empty($rows->qrimage)) {
                                        $img = base_url($rows->qrimage);
                                } else {
                ...
                ?>
                        <tr id="tr_<?=$rows->id?>">							
                            ...
                            <td><a href="javascript void(0)" data-bs-toggle="modal" data-bs-target="#kt_modal_edit<?=$rows->id?>"><?= ucfirst($rows->sname)?></a></td>
                           <td><?= $rows->table_number?></td>
                           <td><a href="<?= $print_link?>" target="_blank"><img class="img-fluid w-125px" src="<?=$img?>" alt="<?=$rows->title?>"></a></td>
                        ...
                        <div class="modal fade " id="kt_modal_edit<?=$rows->id?>" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-800px">
                                        ...
                                        <div class="modal-content">
                                                <!--begin::Form-->
                                                <?php $this->load->view('admin/seller_table_save', $edit); ?>
                                                <!--end::Form-->											
                                        </div>
                                </div>
                        </div>
...
$this->load->view('admin/_js_seller_table', $this->data);
?>
