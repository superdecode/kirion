...
<!--end::Modal -->
<!--begin::Post-->
<div class="post d-flex flex-column-fluid" id="kt_post d-print-none">
<!--begin::Container-->
...
<!--begin::Search-->
<div class="d-print-none d-flex align-items-center position-relative my-1">
...
<th class=""><?php if($this->session->userdata('user_id')==1) {?>Nombre del Vendedor<?php } else {?>Nombre de la Tienda<?php } ?></th>
<th class="">Imagen QR</th>
...
$print_link = base_url('Sellers/print_qr/'.$id);
...
<td><a href="<?= $print_link?>" target="_blank;"><?=$rows->sname ?></a>
  </td>
  <td><a href="<?= $print_link?>" target="_blank;"><img src="<?= base_url($rows->file) ?>"  alt="<?= $rows->sname ?>" width="70"></a>
  </td>

<td class="text-end">								

<button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm d-none" onclick="return removeqrData('<?=$rows->id?>');">
...
<!--end::Svg Icon-->
 ...
 <a href="<?= $print_link?>" target="_blank;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header d-print-none">
        <h5 class="modal-title" id="exampleModalLabel">Mostrar QR</h5>&nbsp;&nbsp;&nbsp;
        <button type="button" class="btn btn-warning" id="" onclick="window.print();">Print</button>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body mb-3 d-print-inline-bloc">
         <img src="<?= base_url($rows->file) ?>" class="content-img" alt="<?= $rows->sname ?>">
             <span class="form-control text-center d-print-none"><?= $rows->sname ?></span>   
      </div>
...
$this->load->view('admin/_qccodejs', $this->data);
?>
