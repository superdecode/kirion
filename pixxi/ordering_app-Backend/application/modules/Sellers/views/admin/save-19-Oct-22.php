...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center py-1">
            <div class="">
                <a href="<?= base_url('Sellers/listingSeller') ?>" class="btn btn-white btn-active-light-danger me-2">Back</a>
...
?>
           ...
           <div class="col-lg-6">
            ...
            <div class="col-lg-6">
            <div class="fv-row mb-5 fv-plugins-icon-container">
            <label for="seller_commission" class="required form-label fs-6 fw-bolder mb-3">Seller Commission</label>
            <input class="form-control form-control-lg form-control-solid" name="seller_commission" type="number" step="0.01" value="<?=$query->seller_commission?>" placeholder="commission on percentage" required>
