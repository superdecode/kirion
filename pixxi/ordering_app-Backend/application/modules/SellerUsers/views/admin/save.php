    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-left me-3 flex-wrap mb-5 mb-lg-0 lh-1">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="<?= base_url('Users/listingSeller') ?>" class="text-muted text-hover-primary">Seller List</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-200 w-5px h-2px"></span>
                </li>
   ...
   <div class="row mb-1">
       <div class="row mb-1">
           ...
           <div class="col-lg-6">
            ...
            <textarea name="seller_details" class="form-control form-control-solid editor" rows="5" placeholder="Seller Details"><?= $query->seller_details ?></textarea>
            </div>
            </div>
           <div class="col-lg-6">
            <div class="fv-row mb-5 fv-plugins-icon-container">
            <label for="message" class="form-label fs-6 fw-bolder mb-3 required">Offer Message</label>
