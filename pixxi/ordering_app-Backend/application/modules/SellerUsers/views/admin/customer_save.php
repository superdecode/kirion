...
<form class="form" id="update_form_<?=$query->id?>" method="POST" action="<?=base_url('Users/customerUpdate/'.$query->id)?>" id="" data-kt-redirect="<?=base_url('Users/customerUpdate/'.$query->id)?>" enctype="multipart/form-data">
	...
	<div class="modal-header" id="kt_modal_edit_header">
		<!--begin::Modal title-->
		<h2 class="fw-bolder">Save Customer</h2>
		<!--end::Modal title-->
		<!--begin::Close-->
	...
	<div class="modal-body py-10 px-lg-17">
		...
		<div class="scroll-y me-n7 pe-7" id="kt_modal_edit_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_header" data-kt-scroll-wrappers="#kt_modal_edit_scroll" data-kt-scroll-offset="300px">
				...
				<label class="fs-6 fw-bold mb-2">Email</label>
                                <input class="form-control form-control-solid" type="text" value="<?=$query->login_id?>" name="login_id" placeholder="Email" autocomplete="off" readonly="true">
				
			</div>
                        <div class="fv-row mb-7">
				<label class="required fs-6 fw-bold mb-2">Fname</label>
				 <input class="form-control form-control-solid" type="text" value="<?=$query->fname?>" name="fname" placeholder="Fname" autocomplete="off" required>
			</div>
                        <div class="fv-row mb-7">
				<label class="required fs-6 fw-bold mb-2">Lname</label>
				 <input class="form-control form-control-solid" type="text" value="<?=$query->lname?>" name="lname" placeholder="Lname" autocomplete="off" required>
			</div>
                    <div class="fv-row mb-7">
				<label class="fs-6 fw-bold mb-2">Phone</label>
				 <input class="form-control form-control-solid" type="text" value="<?=$query->phone_no?>" name="phone" placeholder="Phone" autocomplete="off" >
			</div>
                        
                        <div class="fv-row mb-7">
				<label class="fs-6 fw-bold mb-2">Profile image</label>
