<!--begin::Form-->
<form class="form" id="update_form_<?=$query->id?>" method="POST" action="<?=base_url('Users/add_qr_data/')?>" id="" data-kt-redirect="<?=base_url('Users/add_qr_data/')?>" enctype="multipart/form-data">
	<!--begin::Modal header-->
