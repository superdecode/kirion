<!--begin::Form-->
<form class="form" id="update_form_<?=$query->id?>" method="POST" action="<?=base_url('Users/sellerTypeSave/'.$query->id)?>" id="" data-kt-redirect="<?=base_url('Banners/save/'.$query->id)?>" enctype="multipart/form-data">
	<!--begin::Modal header-->
