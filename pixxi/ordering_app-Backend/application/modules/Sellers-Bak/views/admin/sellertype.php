                            ...
                            <td><a href="javascript void(0)" data-bs-toggle="modal" data-bs-target="#kt_modal_edit<?=$rows->id?>"><?= ucfirst($rows->seller_type)?></a></td>
                                ...
                                <td class="text-end">								
                                    <button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_edit<?=$rows->id?>">
                                        ...
                                        <button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" onclick="return removeSellerTypeData('<?=$rows->id?>');">
