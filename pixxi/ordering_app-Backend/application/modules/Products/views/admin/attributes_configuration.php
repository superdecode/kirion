	...
	<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
		...
		<!--begin::Title-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="<?= base_url('Products/attributes') ?>" class="text-muted text-hover-primary">Options List</a>
                    </li>
                    <!--end::Item-->
		...
		<div class="d-flex align-items-center py-1">
			<div class="">
				...
				<!--end::Svg Icon-->Add Configuration</button>
...
<div class="modal fade " id="kt_modal_add" tabindex="-1" aria-hidden="true">
	...
	<div class="modal-dialog modal-dialog-centered mw-800px">
		...
		<div class="modal-content">
			...
			<?php			
				$this->load->view('admin/attribute_configuration_save'); 
			?>
			<!--end::Form-->											
		</div>
	</div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table">
                ...
                <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 gs-0">
                                ...
                                <th class="min-w-125px">Configuration Name</th>
                ...
                if(!empty($datas)){
                        foreach($datas as $k=> $rows)
                        {
                                ...
                                $delete_link = base_url('Products/attributeConfigurationRemove/'.$id);
                                $status_link = base_url('Products/attributeConfigurationStatusChange/'.$id .'/'.$cid);
                                $query = $this->Product_model->getConfigurationDetails($rows->id);
                                $edit['query']=$query;
                ...
                <tr id="tr_<?=$rows->id?>">							
                       ...
                       <td>
                        ...
                        <a href="javascript:void()" class="text-gray-600 text-hover-primary mb-1" data-bs-toggle="modal" data-bs-target="#kt_modal_edit<?=$rows->id?>"><?=$rows->configuration_name?></a>
                        </td>
                ...
                <div class="modal fade " id="kt_modal_edit<?=$rows->id?>" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-800px">
                                ...
                                <div class="modal-content">
                                        <!--begin::Form-->
                                        <?php $this->load->view('admin/attribute_configuration_save', $edit); ?>
                                        <!--end::Form-->											
                                </div>
                        </div>
                </div>
...
$this->load->view('admin/_confoguration_js', $this->data);
?>
