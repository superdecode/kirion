	...
	<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<!--begin::Title-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="<?= base_url('Products/listing') ?>" class="text-muted text-hover-primary">Lista de Productos</a>
                    </li>
                    <!--end::Item-->
		...
		<div class="d-flex align-items-center py-1">
			<div class="">
				...
				<!--end::Svg Icon-->Agregar Parámetros</button>
...
<div class="modal fade " id="kt_modal_add" tabindex="-1" aria-hidden="true">
	...
	<div class="modal-dialog modal-dialog-centered mw-800px">
		...
		<div class="modal-content">
			<!--begin::Form-->
			<?php			
				$this->load->view('admin/attribute_save'); 
			?>
			<!--end::Form-->											
		</div>
	</div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table">
                ...
                <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 gs-0">
                                ...
                                <th class="min-w-125px">Nombre del Parámetro</th>
                                <th class="min-w-125px <?=$this->session->userdata('user_id')!='1'?'d-none':''?>">Nombre del Vendedor</th>
                ...
                if(!empty($datas)){
                        foreach($datas as $k=> $rows)
                        {
                                ...
                                $edit_link = base_url('Products/attributeSave/'.$id);
                                $confg_att = base_url('Products/attributeConfiguration/'.$id);
                                $delete_link = base_url('Products/attributeSaveRemove/'.$id);
                                $status_link = base_url('Products/attributeStatusChange/'.$id);
                                $query = $this->Product_model->getAttributesDetails($rows->id);
                                $edit['query']=$query;
                ...
                <tr id="tr_<?=$rows->id?>">							
                       ...
                       <td>
                        ...
                        <a href="<?=$confg_att;?>" class="text-gray-600 text-hover-primary mb-1"><?=$rows->attribute_name?></a>
                        </td>
                    <td class="<?=$this->session->userdata('user_id')!='1'?'d-none':''?>">
                           
                        <a class="text-gray-600 text-hover-primary mb-1 "><?=$rows->sname?></a>
                        </td>
                ...
                <div class="modal fade " id="kt_modal_edit<?=$rows->id?>" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-800px">
                                ...
                                <div class="modal-content">
                                        <!--begin::Form-->
                                        <?php $this->load->view('admin/attribute_save', $edit); ?>
                                        <!--end::Form-->											
                                </div>
                        </div>
                </div>
...
$this->load->view('admin/_attribute_js', $this->data);
?>
