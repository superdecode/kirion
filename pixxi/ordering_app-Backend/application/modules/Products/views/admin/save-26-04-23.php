...
Actions
                   ...
                   <li class=""><a href="javascript:void(0)" class="dropdown-item" onclick="return removeDataFromDetails('<?= $query->id ?>');"> Delete</a></li>
                   </ul>
                    <?php } ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <select name="category_id" id="category_id" class="form-select form-control-lg  js-example-basic-single">
                                                        <?= $categories ?>
                                                    </select>
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
...
<div class="fv-plugins-message-container invalid-feedback"></div>
                        ...
                        <div class="card-body border-top p-9">
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                                    <select class="form-select form-select-solid form-select-lg" name="discount_type" tabindex="-98">
                                                        <option value="flat" <?= $query->discount_type == 'flat' ? 'selected' : '' ?>>Flat</option>
                                    ...
                                    <div class="row mb-6">
                                        <label class="col-lg-2 col-form-label fw-bold fs-6">Inventory Item</label>
                                        <div class="col-lg-10">
                                            <div class="row">
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="row mb-6 " style="display:none;" id="inventory_stock">
                                        <label class="col-lg-2 col-form-label fw-bold fs-6">Stock</label>
                                        <div class="col-lg-10">
                                            <div class="row">
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="number" name="current_stock" step="1" min="0" class="form-control" placeholder="Stock" value="<?= $query->current_stock ?>">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-header border-0 cursor-pointer " role="button" data-bs-toggle="collapse" data-bs-target="#product_size_att" aria-expanded="true" aria-controls="product_size_att">
                        <div class="card-title m-0 ">
                            <h3 class="fw-bolder m-5">Product Size </h3>
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-header border-0 cursor-pointer " role="button" data-bs-toggle="collapse" data-bs-target="#cross_sell" aria-expanded="true" aria-controls="cross_sell">
                        <div class="card-title m-0 ">
                            <h3 class="fw-bolder m-0">You May Also Like Section </h3>
                        </div>
                    </div>
                    <div id="product_options" class="collapse show">
                        <div class="card-body border-top p-9">
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row mb-6">
                                        <label class="fs-6 fw-bold mb-2">Select Products</label>
                                        <select class="form-select" id="cross_sell_id" data-control="select2" data-placeholder="Select Products" data-allow-clear="true" multiple="multiple" name="cross_sell_ids[]">
                ...
                <div class="card mb-5 mb-xl-10 <?=$this->session->userdata('user_id')!='1'?'d-none':''?>">
                    <div class="card-header border-0 cursor-pointer " role="button" data-bs-toggle="collapse" data-bs-target="#best_selling" aria-expanded="true" aria-controls="best_selling">
                        <div class="card-title m-0 ">
                            <h3 class="fw-bolder m-0">Recommended Products in Homepage</h3>
                        </div>
                    </div>
                        ...
                        <div class="card-body border-top p-9">
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row mb-6">
                                        <label class="fs-6 fw-bold mb-2">Display in homepage</label>
                                        <div class="form-check-solid form-switch">
                                    ...
                                    <div class="row mb-6" style="display:none;" id="position_order">
                                        ...
                                        <div class="">
                                            <input class="form-control form-control-solid" type="number" value="<?php if ($query->recommended_product == 1) {
                                                                                                                    echo $query->order_no;
                                                                                                                } ?>" name="order_no" placeholder="Order No" autocomplete="off" min="1">
                                        </div>
                                    </div>
