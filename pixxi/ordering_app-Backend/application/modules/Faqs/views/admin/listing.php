	...
	<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
		...
		<div class="d-flex align-items-center py-1">
			<div class="">
				...
				<!--end::Svg Icon-->Añadir Preguntas Frecuentes</button>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table">
                ...
                <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 gs-0">
                                ...
                                <th class="w-50px">Preguntas</th>
                                <th class="w-250px">Respuestas</th>
                                <th class="w-50px">Estado</th>
                                <th class="text-end w-70px">Acciones</th>
                        </tr>
                        <!--end::Table row-->
                </thead>
                <!--end::Table head-->
                ...
                if(!empty($datas)){
                        foreach($datas as $k=> $rows)
                        {
                                ...
                                $edit_link = base_url('Faqs/save/'.$id);
                                $delete_link = base_url('Faqs/remove/'.$id);
                                $status_link = base_url('Faqs/statusChange/'.$id);
                                $query = $this->Faq_model->getFaqDetails($rows->id);
                                $edit['query']=$query;
                ...
                <tr id="tr_<?=$rows->id?>">							
                    ...
                    <td class="text-break anywhere"><?=$rows->description?></td>
                       
                        <td data-filter="">
                                <a href="<?=$status_link?>" class="badge badge-light-<?=($rows->status=='1')?'success':'danger'?>"><?=($rows->status=='1')?'Active':'Deactivate'?></a>
                        </td>
                        <td class="text-end">								
