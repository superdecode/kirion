...
$query = $this->User_model->getCustomerDetails($rows->id);
$edit['query']=$query;
...
<td>
<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#kt_modal_edit<?=$rows->id?>" class="badge badge-light-success"><?=$rows->login_id?> </a>
</td>
<td>
<?=$rows->fname ?> <?=$rows->lname ?>
</td>
<td>
<img class="img-fluid w-125px" src="<?=$img?>" alt="<?=$rows->profile_image?>">
</td>
<td><?php if($rows->phone_no!='') {?><?=$rows->phone_no; } else { echo 'No Disponible'; }?></td>
<td class="text-end">								
...
<div class="modal fade" id="kt_modal_edit<?=$rows->id?>" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
            ...
            <div class="modal-content">
                    <!--begin::Form-->
                    <?php $this->load->view('admin/customer_save', $edit); ?>
                    <!--end::Form-->											
            </div>
    </div>
</div>
