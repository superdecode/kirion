			...
			<div class="card-body pt-0 pb-0">
				...
				<div class="d-flex overflow-auto h-55px">
					<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">						
						...
						<!--begin::Nav item-->
						<li class="nav-item">
							<a class="nav-link text-active-primary me-6 active" href="<?=base_url('Users/account_settings')?>">Configuraciones de la cuenta</a>
						</li>
						<!--end::Nav item-->
						<!--begin::Nav item-->
						<li class="nav-item">
		...
		<!--START::ALERT MESSAGE --><?php $this->load->view('templates/admin/alert');?><!--END::ALERT MESSAGE -->
			...
			<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
				...
				<div class="card-title m-0">
					<h3 class="fw-bolder m-0">Información de la cuenta</h3>
				</div>
				<!--end::Card title-->
			...
			<div id="kt_account_profile_details" class="collapse show">
					...
					<div class="card-body border-top p-9">
						...
						<div class="row mb-6">
							<!--begin::Label-->
							<label class="col-lg-4 col-form-label required fw-bold fs-6">Idioma</label>
							<!--end::Label-->
							<!--begin::Col-->
							<div class="col-lg-8 fv-row">
								<select name="language_id" aria-label="Select a Language" data-control="select2" data-placeholder="Selecciona un idioma..." class="form-select form-select-solid form-select-lg fw-bold" required>
						...
						<div class="row mb-6">
							<!--begin::Label-->
							<label class="col-lg-4 col-form-label fw-bold fs-6">Zona horaria</label>
							<!--end::Label-->
							<!--begin::Col-->
							<div class="col-lg-8 fv-row">
								<select name="time_zone" aria-label="Select a Time Zone" data-control="select2" data-placeholder="Seleccione una zona horaria..." class="form-select form-select-solid form-select-lg fw-bold" >
				...
				<div class="card-body border-top p-9">
					...
					<div class="row mb-0">
						...
						<label class="col-lg-4 col-form-label fw-bold fs-6">
							<span class="">Verificacion de inicio de sesion</span>
							<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Después de iniciar sesión, se le pedirá información adicional para confirmar su identidad y proteger su cuenta para que no se vea comprometida."></i>
						</label>
						<!--begin::Label-->
						<!--begin::Label-->
					...
					<div class="row mb-0" id="authenticate_using_google_div" style="display:<?=($profile->settings->multifactor_authenticate=='1')?'flex':'none';?>; ">
						<!--begin::Label-->
						<label class="col-lg-4 col-form-label fw-bold fs-6">
							<span class="">Verificación a través de Google Authenticater</span>
						</label>
						<!--begin::Label-->
						<!--begin::Label-->
						<div class="col-lg-8 d-flex align-items-center">
					...
					<div class="row mb-6" id="google_id_div" style="display:<?=($profile->settings->multifactor_authenticate=='1' && ($profile->settings->authenticate_using_google=='1') )?'flex':'none';?>; ">
						<!--begin::Label-->
						<label class="col-lg-4 col-form-label fw-bold fs-6">Código secreto</label>
						<!--end::Label-->
						<!--begin::Col-->
						<div class="col-lg-8 fv-row">
					...
					<div class="row mb-6" id="google_qr_code_div" style="display:<?=($profile->settings->multifactor_authenticate=='1' && ($profile->settings->authenticate_using_google=='1') )?'flex':'none';?>; ">
						<!--begin::Label-->
						<label class="col-lg-4 col-form-label fw-bold fs-6">Código QR</label>
						<!--end::Label-->
						<!--begin::Col-->
						<div class="col-lg-8 fv-row">
					...
					<div class="row mb-6" id="google_auth_code_div" style="display:<?=($profile->settings->multifactor_authenticate=='1' && ($profile->settings->authenticate_using_google=='1') )?'flex':'none';?>; ">
						<!--begin::Label-->
						<label class="col-lg-4 col-form-label fw-bold fs-6">Código de autenticación de Google</label>
						<!--end::Label-->
						<!--begin::Col-->
						<div class="col-lg-8 fv-row">
					...
					<div class="row mb-6" id="google_app_download_div" style="display:<?=($profile->settings->multifactor_authenticate=='1' && ($profile->settings->authenticate_using_google=='1') )?'flex':'none';?>; ">
						<!--begin::Label-->
						<label class="col-lg-4 col-form-label fw-bold fs-6">Obtenga Google Authenticator en su teléfono</label>
						<!--end::Label-->
						<!--begin::Col-->
						<div class="col-lg-8">
							<!--begin::Row-->
