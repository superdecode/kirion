    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-left me-3 flex-wrap mb-5 mb-lg-0 lh-1">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="<?= base_url('Users/listingSeller') ?>" class="text-muted text-hover-primary">Lista de Vendedores</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-200 w-5px h-2px"></span>
                </li>
        ...
        <div class="d-flex align-items-center py-1">
            <div class="">
                <a href="<?= base_url('Users/listingSeller') ?>" class="btn btn-white btn-active-light-danger me-2">Atrás</a>
...
<div class="col-md-10">							
   <div class="row mb-1">
       <div class="row mb-1">
           ...
           <div class="fv-row mb-7">
               <label class="required fs-6 fw-bold mb-2">Tipo De Vendedor</label>
               
               <select class="form-select" id="seller_type" data-control="select2" data-placeholder="Tipo De Vendedor" data-allow-clear="true" multiple="multiple" name="seller_type[]" required="">
                    <?php
                    if(!empty($seller_type)){
                            $catsArr = explode(',',$query->seller_type);
                            foreach($seller_type as $k1=>$sellertype){
                    ?>
                    <option value="<?=$sellertype->id?>"<?php if(in_array($sellertype->id,$catsArr)){ echo 'selected'; } ?> ><?=$sellertype->seller_type?></option>
                    <?php
                            }
                    }
                    ?>
            ...
            <label for="sellername" class="form-label fs-6 fw-bolder mb-3 required">Nombre del Vendedor</label>
           ...
           <div class="col-lg-6">
            ...
            <div class="col-lg-6">
            <div class="fv-row mb-5 fv-plugins-icon-container">
            <label for="open_time" class="form-label fs-6 fw-bolder mb-3 required">Horario De Apertura</label>
           ...
           <div class="col-lg-6">
            <div class="fv-row mb-5 fv-plugins-icon-container">
            <label for="close_time" class="form-label fs-6 fw-bolder mb-3 required">Hora de cierre</label>
           ...
           <div class="col-lg-6">
            ...
            <textarea name="seller_details" class="form-control form-control-solid editor" rows="5" placeholder="Datos del Vendedor"><?= $query->seller_details ?></textarea>
            </div>
            </div>
           <div class="col-lg-6">
            <div class="fv-row mb-5 fv-plugins-icon-container">
            <label for="message" class="form-label fs-6 fw-bolder mb-3 required">Mensaje de Oferta</label>
