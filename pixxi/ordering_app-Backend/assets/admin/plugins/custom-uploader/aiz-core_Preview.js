        ...
        removeAttachment: function () {
            $(document).on("click",'.remove-attachment', function () {
                ...
                var selected = $(this)
                    ...
                    .map(Number);
//alert(selected);
var count_elements = $('.file-preview-item').length;
					...
					data = JSON.parse(data);
                        ...
                        $(".product_preview").html(null);
                         var preview_thumb =
                                        ...
                                        base_url + 'assets/uploads/files_manager/'+
                                        data[0].file_name +
                                        '" class="img-fit img-thumbnail removedata">'; 
                                $(".product_preview").append(preview_thumb);
